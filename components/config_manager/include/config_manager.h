...
#define CONFIG_SET_U8(ns, key, val)    config_manager_set(ns, key, CONFIG_TYPE_UINT8, &(val), sizeof(uint8_t))
#define CONFIG_SET_U16(ns, key, val)   config_manager_set(ns, key, CONFIG_TYPE_UINT16, &(val), sizeof(uint16_t))
#define CONFIG_SET_U32(ns, key, val)   config_manager_set(ns, key, CONFIG_TYPE_UINT32, &(val), sizeof(uint32_t))
#define CONFIG_SET_I8(ns, key, val)    config_manager_set(ns, key, CONFIG_TYPE_INT8, &(val), sizeof(int8_t))
#define CONFIG_SET_I16(ns, key, val)   config_manager_set(ns, key, CONFIG_TYPE_INT16, &(val), sizeof(int16_t))
#define CONFIG_SET_I32(ns, key, val)   config_manager_set(ns, key, CONFIG_TYPE_INT32, &(val), sizeof(int32_t))
#define CONFIG_SET_FLOAT(ns, key, val) config_manager_set(ns, key, CONFIG_TYPE_FLOAT, &(val), sizeof(float))
#define CONFIG_SET_BOOL(ns, key, val)  config_manager_set(ns, key, CONFIG_TYPE_BOOL, &(val), sizeof(bool))
#define CONFIG_SET_STR(ns, key, val)   config_manager_set(ns, key, CONFIG_TYPE_STRING, val, strlen(val) + 1)
#define CONFIG_SET_BLOB(ns, key, val, sz) config_manager_set(ns, key, CONFIG_TYPE_BLOB, val, sz)

#define CONFIG_GET_U8(ns, key, val)    config_manager_get(ns, key, CONFIG_TYPE_UINT8, val, NULL)
#define CONFIG_GET_U16(ns, key, val)   config_manager_get(ns, key, CONFIG_TYPE_UINT16, val, NULL)
#define CONFIG_GET_U32(ns, key, val)   config_manager_get(ns, key, CONFIG_TYPE_UINT32, val, NULL)
#define CONFIG_GET_I8(ns, key, val)    config_manager_get(ns, key, CONFIG_TYPE_INT8, val, NULL)
#define CONFIG_GET_I16(ns, key, val)   config_manager_get(ns, key, CONFIG_TYPE_INT16, val, NULL)
#define CONFIG_GET_I32(ns, key, val)   config_manager_get(ns, key, CONFIG_TYPE_INT32, val, NULL)
#define CONFIG_GET_FLOAT(ns, key, val) config_manager_get(ns, key, CONFIG_TYPE_FLOAT, val, NULL)
#define CONFIG_GET_BOOL(ns, key, val)  config_manager_get(ns, key, CONFIG_TYPE_BOOL, val, NULL)
#define CONFIG_GET_STR(ns, key, val, sz) config_manager_get(ns, key, CONFIG_TYPE_STRING, val, sz)
#define CONFIG_GET_BLOB(ns, key, val, sz) config_manager_get(ns, key, CONFIG_TYPE_BLOB, val, sz)
