 ...
 * robOS, including voltage monitoring through ADC and power chip communication
 * via UART.
 *
 * Features:
 ...
 */
typedef void (*power_monitor_event_callback_t)(
    power_monitor_event_type_t event_type, void *event_data, void *user_data);
